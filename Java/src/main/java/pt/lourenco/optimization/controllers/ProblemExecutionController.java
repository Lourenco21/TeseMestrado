...
public class ProblemExecutionController {
    ...
    public ProblemExecutionController(ProblemDataBuilderService problemDataBuilderService, PromptBuilderService promptBuilderService, LlmTestService llmTestService){
