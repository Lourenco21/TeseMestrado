...
export const constraintLibrary = {
  timetabling: [
    { id: "no_teacher_overlap", label: "Professor não pode estar em dois lugares ao mesmo tempo", hard: true },
    { id: "no_room_overlap", label: "Sala não pode ter duas aulas ao mesmo tempo", hard: true },
    { id: "room_capacity", label: "Capacidade da sala", hard: true },
    { id: "teacher_availability", label: "Disponibilidade do professor", hard: true },
  ],
  scheduling: [
    { id: "resource_availability", label: "Disponibilidade do recurso", hard: true },
    { id: "precedence", label: "Respeitar precedências", hard: true },
  ],
  allocation: [
    { id: "unique_assignment", label: "Atribuição única", hard: true },
    { id: "capacity_limit", label: "Limite de capacidade", hard: true },
  ],
};
