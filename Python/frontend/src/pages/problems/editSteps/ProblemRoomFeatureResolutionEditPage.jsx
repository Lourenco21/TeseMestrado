...
import {
  getProblemDraft,
  updateProblemDraft,
  getProblemRoomFeatureResolutionAnalysis,
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <p style={styles.description}>
          Associe cada característica pedida nas aulas, que não existe no ficheiro
          de salas, às características disponíveis no ficheiro de salas. Uma
          característica pedida pode corresponder a várias opções de sala.
        </p>
